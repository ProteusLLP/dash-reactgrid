...
dashReactGrid <- function(id=NULL, columns=NULL, data=NULL, enableColumnSelection=NULL, enableFillHandle=NULL, enableRangeSelection=NULL, enableRowSelection=NULL, highlights=NULL, selectedCell=NULL, stickyBottomRows=NULL, stickyLeftColumns=NULL, stickyRightColumns=NULL, stickyTopRows=NULL, style=NULL, styleHeader=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'columns', 'data', 'enableColumnSelection', 'enableFillHandle', 'enableRangeSelection', 'enableRowSelection', 'highlights', 'selectedCell', 'stickyBottomRows', 'stickyLeftColumns', 'stickyRightColumns', 'stickyTopRows', 'style', 'styleHeader'),
